...
import { ConstructionDiarySchema, IConstructionDiary, IObrasItem } from "../../../stores/obras/interface";
...
import { addConstructionDiary, getAllConstructionItems } from "../../../stores/obras/service";

const AddNewDiaryItem = ({ id, flushHook }: { id: string, flushHook: any }) => {
            ...
            <Grid templateColumns="repeat(2, 1fr)" gap={6} fontFamily="Poppins-Regular">
                ...
                <FormControl>
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <Select defaultValue="" {...field}>
                                <option disabled key={1} value="">Item</option>
                                <option key={2} value="construcao">construcao</option>
                ...
                <FormControl>
                    ...
                    <Input {...register("type")} placeholder="Exemplo da Silva LTDA" />
