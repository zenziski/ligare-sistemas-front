import { Flex, Progress, Table, TableContainer, Tbody, Text, Th, Thead, Tr, useToast } from "@chakra-ui/react";
        ...
        const fetch = async () => {
            ...
            try {
                ...
                toast({
                    ...
                    description: 'Ocorreu um erro ao buscar os feriados, tente novamente mais tarde',
                    status: 'error',
                    duration: 9000,
                    isClosable: true
                })
    ...
    return (
        <Sidebar>
            <Flex height="100%" width="100%" p={10} direction="column">
                ...
                >
                    <ModalCriarFeriado 
                        onFlushHook={() => setFlushHook(!flushHook)}
                    />
                </Flex>
                <TableContainer
                    mt={10}
